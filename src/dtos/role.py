...
from src.dtos.common import RoleKey, SafeText
...
class RoleCreateRequest(BaseModel):
    ...
    name: SafeText = Field(min_length=2, max_length=60)
    description: SafeText = Field(default="", max_length=200)
    permissions: list[str] = Field(default_factory=list, max_length=50)


class RoleUpdateRequest(BaseModel):
    name: SafeText | None = Field(default=None, min_length=2, max_length=60)
    description: SafeText | None = Field(default=None, max_length=200)
